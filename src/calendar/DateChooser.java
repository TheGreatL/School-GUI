...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        popup = new javax.swing.JPopupMenu() {
            ...
            protected void paintComponent(Graphics grphcs) {
                ...
                grphcs.setColor(new Color(211, 213, 191));
                grphcs.fillRect(1, 1, getWidth() - 2, getHeight() - 2);
            }
        };
        header = new javax.swing.JPanel();
        cmdForward = new calendar.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new calendar.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new calendar.Button();
        cmdPrevious = new calendar.Button();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/calendar/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/calendar/previous.png"))); // NOI18N
    ...
    private calendar.Button cmdForward;
    private calendar.Button cmdMonth;
    private calendar.Button cmdPrevious;
    private calendar.Button cmdYear;
